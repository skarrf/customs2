-- Generic Dragon - Vanok
-- Scripted by ColdYogurt
-- Cards Used: Starling 342444455, Clock Arc 87468732, Abomination's Prison 27412542
local s,id=GetID()
...
function s.thfilter(c)
	--return c:IsMonster() and c:IsSetCard(0x39a) and c:IsAbleToHand()
	return c:IsSetCard(0x39a) and c:IsAbleToHand()
end
